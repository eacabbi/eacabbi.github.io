...
This paper provides a new framework to evaluate the interactions between labor market sorting and business cycle fluctuations. We estimate a tractable labor market search equilibrium model with aggregate risk, firm and worker heterogeneity, life-cycle dynamics and endogenous human capital accumulation, using matched employer-employee data on the universe of the Italian workforce. We show that distortions in both human capital accumulation and sorting of workers to firms are key factors in explaining the persistent effects of the business cycle. Our model therefore directly relates labor reallocation to economic hysteresis. Fluctuations have substantial welfare effects for workers on average, with significant heterogeneous effects along the earnings distribution. Output dynamics exhibit a considerable degree of state dependence, with features from the labor compensation distribution being key predictors of the severity of downturns. Finally, our model is able to account for the increased length of recessions in recent decades.
