...
Acabbi, Edoardo M., Panetti, Ettore and Sforza, Alessandro (2020). **The Financial Channels of Labor Rigidities: Evidence from Portugal.** <a href="{{ site.baseurl }}/docs/eacabbi_jmp.pdf" class="{{ site.link_icon }}" title="{{ site.link_title }}" id="icon"></a>
